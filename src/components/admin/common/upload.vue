...
<script>
  ...
  export default{
    ...
    props:{
      ...
      imgSrc: {
        type: String,
        default: require('@/assets/admin/images/add.png')
      },
      maxUploadNumber:{
        type:Number,
        default:5
...
<style scoped>
  ...
  .uploadItem{display:inline-block;margin-right:10px;background-color: white;border-radius: 5px;vertical-align: middle;font-size: 28px;}
  ...
  .uploadItem .uploadItemImg .shadowBox .img2{width:15%;padding:4px;cursor: pointer;position: absolute;top:-15%;right: -15%;}

  .bigImgBox{width:100%;height: 100%;position: fixed;top:0;background-color: rgba(0,0,0,0.5);left: 0;z-index: 99999;}
  .bigImgBox .bigImgCon{width:100%;background-color: white;padding:20px;box-sizing:border-box;position: relative;top:50%;left:50%;transform:translate(-50%,-50%);}
